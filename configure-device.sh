...
# Set the MAKITA_RUBY_SCRIPT environment variable to your Ruby script path.
...
# RUBY_SCRIPT = "$USER_HOME/.config/makita/scripts/my_script.rb"

# Example usage:
# export MAKITA_RUBY_SCRIPT="$USER_HOME/.config/makita/examples/ruby_scripts/eat_input.rb"
...
# Example Ruby script for Makita
